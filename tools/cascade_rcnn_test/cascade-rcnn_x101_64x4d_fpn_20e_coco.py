...
backend_args = None
data_root = 'E:/系统开发/AI/AI_Study/mmdetection_main/data/coco/'
...
test_evaluator = dict(
    ann_file=
    'E:/系统开发/AI/AI_Study/mmdetection_main/data/coco/annotations/instances_val2017.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
