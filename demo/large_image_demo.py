...
# 效率比large_image_demo2.py高，但是精度不行，很多误提
def main():
    args = parse_args()
...
# python demo/large_image_demo.py  demo/large_image.jpg  configs/faster_rcnn/faster-rcnn_r101_fpn_2x_coco.py checkpoints/faster_rcnn_r101_fpn_2x_coco_bbox_mAP-0.398_20200504_210455-1d2dac9c.pth


# python large_image_demo.py ../demo/large_image.jpg ../configs/faster_rcnn/faster-rcnn_r101_fpn_2x_coco.py ../checkpoints/faster_rcnn_r101_fpn_2x_coco_bbox_mAP-0.398_20200504_210455-1d2dac9c.pth
...
# mask提取失败
# python large_image_demo.py   ../demo/airplane/air3.jpg ../data/mmdet-insseg/airplane/airplane_mmdet_v3-insseg-mask_rcnn_mask.py ../checkpoints/vgis/airplane/airplane_mmdet_v3-insseg-mask_rcnn_mask.pth

# hbb提取成功了，但cascade_rcnn比mask_rcnn的精度低了很多，有误提，提取结果做了后处理，merge_results_by_nms
# python large_image_demo.py   ../demo/airplane/bigimg.jpg ../data/mmdet-objdet/airplane/airplane_mmdet_v3-objdet-cascade_rcnn_hbb.py ../checkpoints/vgis/airplane/airplane_mmdet_v3-objdet-cascade_rcnn_hbb.pth
#
# python large_image_demo.py   ../demo/boat/big_img.jpg   ../data/mmdet-insseg/boat/boat_mmdet_v3-insseg-mask_rcnn_mask.py ../checkpoints/vgis/boat/boat_mmdet_v3_insseg-mask-rcnn_mask.pth
